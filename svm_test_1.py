...
svm = SVC(kernel='linear', class_weight='balanced')  # 'linear' means it uses a straight line to separate the categories
# You can experiment with different kernels like 'rbf' (radial basis function) for more complex boundaries
